    ...
    <div className="min-h-[100dvh] w-full bg-neutral-200 dark:bg-neutral-950 flex flex-col items-center justify-center relative font-sans transition-colors duration-200">
      ...
      {inAppAlert && (
        <div
          ...
          className="fixed in-app-alert-safe z-50 max-w-md w-[92%] bg-neutral-900/95 dark:bg-[#1c1c1e]/95 text-white p-3.5 rounded-2xl shadow-2xl border border-amber-500/40 flex items-start justify-between gap-3 animate-in slide-in-from-top duration-200 backdrop-blur-md"
        >
